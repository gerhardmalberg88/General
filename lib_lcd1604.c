...
void LCD1602_1stLine(void)  // 1. row
{
 LCD1602_setCursor(1,1);
}
void LCD1602_2ndLine(void) // 2. row
{
 LCD1602_setCursor(2,1); 
}

void LCD1602_3ndLine(void) // 3. row
{
 LCD1602_setCursor(3,1);
}

void LCD1602_4ndLine(void) // 4. row
{
